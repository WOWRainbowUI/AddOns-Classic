...
VUHDO_BOUQUET_BUFFS_SPECIAL = {
	...
	["CUSTOM_FLAG"] = {
		...
		["updateCyclic"] = true,
		["interests"] = { VUHDO_UPDATE_HEALTH, VUHDO_UPDATE_HEALTH_MAX, VUHDO_UPDATE_RANGE, VUHDO_UPDATE_ALIVE, UHDO_UPDATE_DC, VUHDO_UPDATE_SPELL_TRACE, VUHDO_UPDATE_HEALTH_COMBAT_LOG }, --ignoring some for now (eg. VUHDO_UPDATE_INC, VUHDO_UPDATE_NUM_CLUSTER, VUHDO_UPDATE_MANA, etc.)
	},

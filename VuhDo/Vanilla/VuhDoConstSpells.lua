...
VUHDO_SPELL_ID.EFFLORESCENCE = VUHDO_getSpellInfoSafe(417148);
...
VUHDO_SPELL_ID.LIFEBLOOM = VUHDO_getSpellInfoSafe(408124);
...
VUHDO_SPELL_ID.PRAYER_OF_MENDING = VUHDO_getSpellInfoSafe(401859);
...
VUHDO_SPELL_ID.PURIFY = VUHDO_getSpellInfoSafe(1152);
...
VUHDO_SPELL_ID.REMOVE_GREATER_CURSE = VUHDO_getSpellInfoSafe(412113);
...
VUHDO_SPELL_ID.REVIVE = VUHDO_getSpellInfoSafe(437138);
VUHDO_SPELL_ID.REWIND = VUHDO_getSpellInfoSafe(363534);
VUHDO_SPELL_ID.RIPTIDE = VUHDO_getSpellInfoSafe(408521);
...
VUHDO_SPELL_ID.WILD_GROWTH = VUHDO_getSpellInfoSafe(408120);
...
VUHDO_SPELL_ID.CHI_COCOON = VUHDO_getSpellInfoSafe(406139);
VUHDO_SPELL_ID.ASPECT_OF_HARMONY = VUHDO_getSpellInfoSafe(450508);
VUHDO_SPELL_ID.PURIFIED_SPIRIT = VUHDO_getSpellInfoSafe(450805);
...
-- Priest
VUHDO_SPELL_ID.BUFF_POWER_WORD_FORTITUDE        = VUHDO_getSpellInfoSafe(1243);
VUHDO_SPELL_ID.BUFF_PRAYER_OF_FORTITUDE         = VUHDO_getSpellInfoSafe(21562);
VUHDO_SPELL_ID.BUFF_SHADOW_PROTECTION           = VUHDO_getSpellInfoSafe(976);
VUHDO_SPELL_ID.BUFF_PRAYER_OF_SHADOW_PROTECTION = VUHDO_getSpellInfoSafe(27683);
VUHDO_SPELL_ID.BUFF_DIVINE_SPIRIT               = VUHDO_getSpellInfoSafe(14752);
VUHDO_SPELL_ID.BUFF_PRAYER_OF_SPIRIT            = VUHDO_getSpellInfoSafe(27681);
...
VUHDO_SPELL_ID.BUFF_SHADOWGUARD                 = VUHDO_getSpellInfoSafe(18137);
VUHDO_SPELL_ID.BUFF_TOUCH_OF_WEAKNESS           = VUHDO_getSpellInfoSafe(19266);


-- Shaman
-- Fire
VUHDO_SPELL_ID.BUFF_FIRE_ELEMENTAL_TOTEM   = VUHDO_getSpellInfoSafe(2894);
VUHDO_SPELL_ID.BUFF_MAGMA_TOTEM            = VUHDO_getSpellInfoSafe(25552);
VUHDO_SPELL_ID.BUFF_FIRE_RESISTANCE_TOTEM  = VUHDO_getSpellInfoSafe(25563);
VUHDO_SPELL_ID.BUFF_FROST_RESISTANCE_TOTEM = VUHDO_getSpellInfoSafe(25560);
VUHDO_SPELL_ID.BUFF_FIRE_NOVA_TOTEM        = VUHDO_getSpellInfoSafe(25547);
VUHDO_SPELL_ID.BUFF_SEARING_TOTEM          = VUHDO_getSpellInfoSafe(25533);
VUHDO_SPELL_ID.BUFF_FLAMETONGUE_TOTEM      = VUHDO_getSpellInfoSafe(25557);
-- Air
VUHDO_SPELL_ID.BUFF_GROUNDING_TOTEM         = VUHDO_getSpellInfoSafe(8177);
VUHDO_SPELL_ID.BUFF_WINDFURY                = VUHDO_getSpellInfoSafe(25587);
VUHDO_SPELL_ID.BUFF_GRACE_OF_AIR            = VUHDO_getSpellInfoSafe(25359);
VUHDO_SPELL_ID.BUFF_WRATH_OF_AIR            = VUHDO_getSpellInfoSafe(3738);
VUHDO_SPELL_ID.BUFF_NATURE_RESISTANCE_TOTEM = VUHDO_getSpellInfoSafe(25574);
VUHDO_SPELL_ID.BUFF_SENTRY_TOTEM            = VUHDO_getSpellInfoSafe(6495);
VUHDO_SPELL_ID.BUFF_WINDWALL_TOTEM          = VUHDO_getSpellInfoSafe(25577);
VUHDO_SPELL_ID.BUFF_TRANQUIL_AIR_TOTEM      = VUHDO_getSpellInfoSafe(25908);
-- Earth
...
VUHDO_SPELL_ID.BUFF_STRENGTH_OF_EARTH     = VUHDO_getSpellInfoSafe(25361);
VUHDO_SPELL_ID.BUFF_STONECLAW_TOTEM       = VUHDO_getSpellInfoSafe(10428);
VUHDO_SPELL_ID.BUFF_STONESKIN_TOTEM       = VUHDO_getSpellInfoSafe(10408);
-- Water
...
VUHDO_SPELL_ID.BUFF_MANA_SPRING_TOTEM       = VUHDO_getSpellInfoSafe(25570);
VUHDO_SPELL_ID.BUFF_POISON_CLEANSING_TOTEM  = VUHDO_getSpellInfoSafe(8166);
VUHDO_SPELL_ID.BUFF_DISEASE_CLEANSING_TOTEM = VUHDO_getSpellInfoSafe(8170);

-- Weapon Enchants
VUHDO_SPELL_ID.BUFF_ROCKBITER_WEAPON   = VUHDO_getSpellInfoSafe(16316);
VUHDO_SPELL_ID.BUFF_WINDFURY_WEAPON    = VUHDO_getSpellInfoSafe(25505);
VUHDO_SPELL_ID.BUFF_FLAMETONGUE_WEAPON = VUHDO_getSpellInfoSafe(16342);
VUHDO_SPELL_ID.BUFF_FROSTBAND_WEAPON   = VUHDO_getSpellInfoSafe(25500);
...
VUHDO_SPELL_ID.BUFF_LIGHTNING_SHIELD = VUHDO_getSpellInfoSafe(25020);
VUHDO_SPELL_ID.BUFF_WATER_SHIELD = VUHDO_getSpellInfoSafe(33736);
...
VUHDO_SPELL_ID.BUFF_BEACON_OF_VIRTUE = VUHDO_getSpellInfoSafe(200025);
VUHDO_SPELL_ID.BUFF_STAY_OF_EXECUTION = VUHDO_getSpellInfoSafe(114917);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_KINGS = VUHDO_getSpellInfoSafe(25898);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_WISDOM = VUHDO_getSpellInfoSafe(25894);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_MIGHT = VUHDO_getSpellInfoSafe(25782);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_SANCTUARY = VUHDO_getSpellInfoSafe(25899);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_LIGHT = VUHDO_getSpellInfoSafe(25890);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_SALVATION = VUHDO_getSpellInfoSafe(25895);
...
VUHDO_SPELL_ID.BUFF_GIFT_OF_THE_WILD = VUHDO_getSpellInfoSafe(21849);
VUHDO_SPELL_ID.BUFF_THORNS           = VUHDO_getSpellInfoSafe(467);
VUHDO_SPELL_ID.BUFF_OMEN_OF_CLARITY  = VUHDO_getSpellInfoSafe(16864);


-- Warlock
VUHDO_SPELL_ID.BUFF_DEMON_SKIN  = VUHDO_getSpellInfoSafe(687);
VUHDO_SPELL_ID.BUFF_DEMON_ARMOR = VUHDO_getSpellInfoSafe(706);


-- Mage
VUHDO_SPELL_ID.BUFF_ARCANE_INTELLECT   = VUHDO_getSpellInfoSafe(1459);
VUHDO_SPELL_ID.BUFF_ARCANE_BRILLIANCE  = VUHDO_getSpellInfoSafe(23028);
VUHDO_SPELL_ID.BUFF_ICE_BLOCK          = VUHDO_getSpellInfoSafe(11958);
...
VUHDO_SPELL_ID.BUFF_MOLTEN_ARMOR       = VUHDO_getSpellInfoSafe(428741);
VUHDO_SPELL_ID.BUFF_FROST_ARMOR        = VUHDO_getSpellInfoSafe(168);
VUHDO_SPELL_ID.BUFF_ICE_ARMOR          = VUHDO_getSpellInfoSafe(7302);
VUHDO_SPELL_ID.BUFF_AMPLIFY_MAGIC      = VUHDO_getSpellInfoSafe(10170);
VUHDO_SPELL_ID.BUFF_DAMPEN_MAGIC       = VUHDO_getSpellInfoSafe(10174);
...
VUHDO_SPELL_ID.BUFF_LEECHING_POISON = VUHDO_getSpellInfoSafe(108211);
...
VUHDO_SPELL_ID.DEBUFF_SHATTERPULSE = VUHDO_getSpellInfoSafe(1250008);
VUHDO_SPELL_ID.DEBUFF_SOULCRUSH = VUHDO_getSpellInfoSafe(1242284);


-- SoD Rune Abilities
VUHDO_SPELL_ID.HELM_RUNE_ABILITY = VUHDO_getSpellInfoSafe(417345);
VUHDO_SPELL_ID.CHEST_RUNE_ABILITY = VUHDO_getSpellInfoSafe(399954);
VUHDO_SPELL_ID.LEGS_RUNE_ABILITY = VUHDO_getSpellInfoSafe(399966);
VUHDO_SPELL_ID.HANDS_RUNE_ABILITY = VUHDO_getSpellInfoSafe(399967);
VUHDO_SPELL_ID.WAIST_RUNE_ABILITY = VUHDO_getSpellInfoSafe(415449);
VUHDO_SPELL_ID.FEET_RUNE_ABILITY = VUHDO_getSpellInfoSafe(415450);
VUHDO_SPELL_ID.BRACER_RUNE_ABILITY = VUHDO_getSpellInfoSafe(417346);
VUHDO_SPELL_ID.SHOULDER_RUNE_ABILITY = VUHDO_getSpellInfoSafe(417348);
VUHDO_SPELL_ID.CLOAK_RUNE_ABILITY = VUHDO_getSpellInfoSafe(417347);

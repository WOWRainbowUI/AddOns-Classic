...
VUHDO_CLASS_BUFFS = {
	...
	["PRIEST"] = {
		[VUHDO_SPELL_ID.BUFF_POWER_WORD_FORTITUDE] = {
			...
			{ VUHDO_SPELL_ID.BUFF_PRAYER_OF_FORTITUDE, VUHDO_BUFF_TARGET_GROUP, GROUP_STAM },
			-- TESTING: Temporarily use single-target version to test GROUP targeting logic
			-- { VUHDO_SPELL_ID.BUFF_POWER_WORD_FORTITUDE, VUHDO_BUFF_TARGET_GROUP, GROUP_STAM },
		},
		[VUHDO_SPELL_ID.BUFF_SHADOW_PROTECTION] = {
			{ VUHDO_SPELL_ID.BUFF_SHADOW_PROTECTION, VUHDO_BUFF_TARGET_SINGLE, GROUP_SHADOW },
			{ VUHDO_SPELL_ID.BUFF_PRAYER_OF_SHADOW_PROTECTION, VUHDO_BUFF_TARGET_GROUP, GROUP_SHADOW },
		},
		[VUHDO_SPELL_ID.BUFF_DIVINE_SPIRIT] = {
			{ VUHDO_SPELL_ID.BUFF_DIVINE_SPIRIT, VUHDO_BUFF_TARGET_SINGLE, GROUP_SPIRIT },
			{ VUHDO_SPELL_ID.BUFF_PRAYER_OF_SPIRIT, VUHDO_BUFF_TARGET_GROUP, GROUP_SPIRIT },
		},
	...
	["SHAMAN"] = {
		...
		[VUHDO_I18N_BUFFC_WEAPON_ENCHANT] = {
			...
			{ VUHDO_SPELL_ID.BUFF_FROSTBAND_WEAPON, VUHDO_BUFF_TARGET_ENCHANT },
		},
	},
	...
	["PALADIN"] = {
		...
		[VUHDO_SPELL_ID.BUFF_BEACON_OF_VIRTUE] = {
			{ VUHDO_SPELL_ID.BUFF_BEACON_OF_VIRTUE, VUHDO_BUFF_TARGET_UNIQUE },
		},
	...
	["DRUID"] = { 
		[VUHDO_SPELL_ID.BUFF_MARK_OF_THE_WILD] = {
			...
			{ VUHDO_SPELL_ID.BUFF_GIFT_OF_THE_WILD, VUHDO_BUFF_TARGET_GROUP, GROUP_STATS },
		},
		[VUHDO_SPELL_ID.BUFF_THORNS] = {
			{ VUHDO_SPELL_ID.BUFF_THORNS, VUHDO_BUFF_TARGET_SINGLE },
		},
		[VUHDO_SPELL_ID.BUFF_OMEN_OF_CLARITY] = {
			{ VUHDO_SPELL_ID.BUFF_OMEN_OF_CLARITY, VUHDO_BUFF_TARGET_SELF },
		},
	},
	...
	["MAGE"] = {
		[VUHDO_SPELL_ID.BUFF_ARCANE_BRILLIANCE] = {
			...
			{ VUHDO_SPELL_ID.BUFF_ARCANE_BRILLIANCE, VUHDO_BUFF_TARGET_GROUP, GROUP_INT },
		},
		...
		[VUHDO_SPELL_ID.BUFF_AMPLIFY_MAGIC] = {
			{ VUHDO_SPELL_ID.BUFF_AMPLIFY_MAGIC, VUHDO_BUFF_TARGET_SINGLE },
		},
		[VUHDO_SPELL_ID.BUFF_DAMPEN_MAGIC] = {
			{ VUHDO_SPELL_ID.BUFF_DAMPEN_MAGIC, VUHDO_BUFF_TARGET_SINGLE },
		},
	},

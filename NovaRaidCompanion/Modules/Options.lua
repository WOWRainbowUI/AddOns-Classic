...
NRC.options = {
	...
	args = {
		titleText = {
			type = "description",
			name = "        " .. NRC.prefixColor .. L["NovaRaidCompanion "] .." (v" .. string.format("%.2f", NRC.version) .. ")",
			fontSize = "large",
			order = 1,
		},
		authorText = {
...
NRC.optionDefaults = {
	global = {
		...
		summonMsg = true,
		healthstoneMsg = true,
		soulstoneMsgSay = true,
		soulstoneMsgGroup = true,
		--Warrior.
...
function NRC:loadDatabase()
    ...
    NRC.optionsFrame = LibStub("AceConfigDialog-3.0"):AddToBlizOptions("NovaRaidCompanion", L["NovaRaidCompanion"]);

...
L["Spawned"] = "Spawned";
L["Hold Shift To Drag"] = "按住 Shift 可拖曳移動";
...
L["leftClickMinimapButton"] = "左鍵|r 打開團隊狀態";
L["rightClickMinimapButton"] = "右鍵|r 打開出團紀錄";
L["shiftLeftClickMinimapButton"] = "Shift+左鍵|r 打開交易紀錄";
L["shiftRightClickMinimapButton"] = "Shift+右鍵|r 打開設置";
L["controlLeftClickMinimapButton"] = "Ctrl+左鍵|r 打開拾取紀錄";
L["Merged"] = "合併";
...
L["raidCooldownsShiftLeftClickTitle"] = "Shift+左鍵";
L["raidCooldownsShiftLeftClickDesc"] = "選擇當您Shift+單擊左鍵顯示玩家名稱的冷卻條時會發生什麼（未合併的冷卻條或合併時的工具提示）。";

L["raidCooldownsShiftRightClickTitle"] = "Shift+右鍵";
...
L["|cFFFF6900NRC Raid Status"] = "|cFFFF6900NRC 團隊狀態"
L["|cFFDEDE42NRC Scrolling Events|r"] = "|cFFDEDE42NRC 捲動事件|r"
L["|cFFDEDE42Cooldown List "] = "|cFFDEDE42冷卻清單 "
L["|cFFDEDE42Healer Mana|r"] = "|cFFDEDE42補師魔量|r"
L["Lock"] = "鎖定"

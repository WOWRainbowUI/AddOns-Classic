...
L["SCALETOOLTIPDESC"] = "設定專業技能和材料的浮動提示資訊縮放大小，以符合配方的浮動提示資訊大小 (整體介面縮放大小)。"
L["SCALETOOLTIPNAME"] = "縮放所有浮動提示資訊"
...
L["SHOWCRAFTERSTOOLTIPDESC"] = "在物品的浮動提示資訊中顯示可以製作物品的分身角色"
L["SHOWCRAFTERSTOOLTIPNAME"] = "在浮動提示資訊中顯示製作者"
L["SHOWDETAILEDRECIPETOOLTIPDESC"] = "滑鼠指向左側面板中的配方時顯示浮動提示資訊"
L["SHOWDETAILEDRECIPETOOLTIPNAME"] = "顯示配方的浮動提示資訊"
L["SHOWFULLTOOLTIPDESC"] = "顯示有關要製作的物品的所有資訊。關閉時只會看到縮減內容後的浮動提示資訊 (按住 Ctrl 來顯示完整的浮動提示資訊)。"
L["SHOWFULLTOOLTIPNAME"] = "使用標準的浮動提示資訊"
L["SHOWITEMNOTESTOOLTIPDESC"] = "在該物品的浮動提示資訊中加入自訂備註"
L["SHOWITEMNOTESTOOLTIPNAME"] = "在浮動提示資訊中加入自訂備註"
L["SHOWITEMTOOLTIPDESC"] = "顯示可製作物品的浮動提示資訊，而不是配方的浮動提示資訊。"
L["SHOWITEMTOOLTIPNAME"] = "盡可能顯示物品的浮動提示資訊"
...
L["TOOLTIPSCALEDESC"] = "縮放配方清單、詳細物品和材料的浮動提示資訊。"
L["Total Cost:"] = "總計花費:"
L["Total spent"] = "總價"
...
-- 自行加入
L["Skillet-Classic"] = "專業助手"
L["Skillet"] = "專業-助手"
L["Profiles"] = "設定檔"
L["Skillet-Classic: Ignored Recipes"] = "專業助手: 已忽略的配方"
L["used in queued skills:"] = "排程需要:"
L["created from queued skills:"] = "排程產出:"
L["scan incomplete..."] = "尚未完整掃描..."
L[" not available for alts"] = "無法給分身使用"
L["|r/ Chance:"] = "|r/ 成功機率:"
L["in shopping list:"] = "在購物清單中:"
L["to craft "] = "製作 "
L[" you need:"] = " 個需要:"
...
L["   Profit percentage:\n"] = "   利潤百分比:\n"
L["By Suffix"] = "依據字尾"
L["Skillet-Classic News"] = "專業助手更新資訊"
L["Always"] = "總是"
L["Once per Account"] = "每個帳號顯示一次"
L["Once per Player"] = "每個角色顯示一次"
L["Never"] = "永不"
L["InvertShiftKey"] = "反轉 Shift"
L["Invert sense of shift to open the Blizzard frames"] = "反轉 Shift 鍵打開暴雪視窗的效果"